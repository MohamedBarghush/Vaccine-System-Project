...
int main()
{
	...
	mainManager.CreateEntry("Mohamed Gamal", 2021170458, "Cairo", 21, 'M', "ExtraZinc", true, "21/4/2021", true, "21/6/2021");
	mainManager.CreateEntry("Omar Ahmed", 2021170459, "Cairo", 20, 'M', "ExtraZinc", true, "21/4/2021", false, "");
	mainManager.CreateEntry("Yousef Eslam", 2021170460, "Cairo", 19, 'M', "ExtraZinc", false, "", true, "21/6/2021");
	mainManager.CreateEntry("Samira Adel", 2021170461, "Cairo", 60, 'F', "ExtraZinc", false, "", false, "");
